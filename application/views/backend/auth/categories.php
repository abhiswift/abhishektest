          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
               <h3 class="card-title"><a href="<?php echo base_url('admincontrol/dashboardadmin/add-category'); ?>" class="btn btn-sm btn-primary">Add More</a></h3>
              </div>
              <!-- /.card-header -->
                  ...
                  if(!empty($allcategories)){
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                         <label class="switch">
                          <input type="checkbox" class="switchcheck" <?php if ($value['is_active'] == 2) { echo 'checked="checked"'; } ?> data-id="<?php echo $value['id'];?>" data-url="<?php echo base_url('admincontrol/dashboardadmin/changestatus');?>" data-name="categorylist" >
                          <span class="slider round"></span></label>

                        </td>
                        <td><a href="<?php echo base_url('admincontrol/dashboardadmin/editCategory/'.$value['id']);?>"><i class="fas fa-edit"></i></a></td>
                      </tr>
                    <?php }?>
                  <?php }?>
                  </tbody>
