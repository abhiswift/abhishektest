        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <?php if ($this->session->flashdata('update_order_msg')!= ""){?>
                  <?php echo $this->session->flashdata('update_order_msg'); ?>
              <?php }?>
                  ...
                  <?php if(!empty($all_customers)){
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                         <label class="switch">
                          <input type="checkbox" class="switchcheck" <?php if ($value['user_active'] == 2) { echo 'checked="checked"'; } ?> data-id="<?php echo $value['id'];?>" data-url="<?php echo base_url('admincontrol/dashboardadmin/changestatus');?>" data-name="customerlist" >
                          <span class="slider round"></span></label>

                        </td>
                        <td><?php echo $value['updated_at'];?></td>
                        <td><a href="<?php echo base_url('admincontrol/dashboardadmin/customer-details/'.$value['id']);?>"><i class="fas fa-eye"></i></a></td>
                      </tr>
                    <?php }?>
                  <?php }?>
                  </tbody>
