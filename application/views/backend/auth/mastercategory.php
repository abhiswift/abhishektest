...
<head>
  ...
  <title>Admin | Master Categories</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Master Categories</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="<?php echo base_url('admincontrol/dashboardadmin/add-master-category'); ?>" class="btn btn-sm btn-primary">Add More</a></h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <?php if(!empty($allmastercategory)){
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                         <label class="switch">
                          <input type="checkbox" class="switchcheck" <?php if ($value['is_active'] == 2) { echo 'checked="checked"'; } ?> data-id="<?php echo $value['id'];?>" data-url="<?php echo base_url('admincontrol/dashboardadmin/changestatus');?>" data-name="mastercategorylist" >
                          <span class="slider round"></span></label>

                        </td>
                        <td><a href="<?php echo base_url('admincontrol/dashboardadmin/editMasterCategory/'.$value['id']);?>"><i class="fas fa-edit"></i></a></td>
                      </tr>
                    <?php }?>
                  <?php }?>
                  </tbody>
