...
<head>
  ...
  <title>Admin | Add Master Category</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Master Category</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <?php if(validation_errors() != false){?>
              ...
              <?php }?>
        <form role="form" action="<?php echo base_url('admincontrol/dashboardadmin/submitMasterCategory'); ?>" enctype="multipart/form-data" method="post">
        <div class="row">
          <!-- left column -->
          <div class="col-md-6">
