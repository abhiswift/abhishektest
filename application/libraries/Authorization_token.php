    ...
    public function generateToken($data = null)
    {
        if ($data AND is_array($data))
        {
            ...
            try {
                ...
                return 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjciLCJmdWxsX25hbWUiOm51bGwsImVtYWlsIjpudWxsLCJBUElfVElNRSI6MTU5NzY2NDYyOX0.L6oHftiFo-RmqZKYB0CwzJf-a0BGI2DUmDiHLyM4Cb8';
